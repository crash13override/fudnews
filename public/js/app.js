...
/* harmony import */ var page_flip__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! page-flip */ "./node_modules/page-flip/dist/js/page-flip.browser.js");
...
document.addEventListener('DOMContentLoaded', function () {
  if (window.fudPages && window.fudPages.length > 0) {
    var pageFlip = new page_flip__WEBPACK_IMPORTED_MODULE_0__.PageFlip(document.getElementById("fud-news"), {
      width: 550,
      // base page width
      height: 733,
      // base page height
    ...
    pageFlip.loadFromImages(window.fudPages);
